          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-12">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                ...
                {/* LinkedIn */}
                <a
                  href="https://linkedin.com/company/syentropy"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="LinkedIn"
                  className="w-10 h-10 rounded-xl bg-surface-container-high/50 border border-outline-variant/20 flex items-center justify-center text-on-surface-variant/60 social-linkedin transition-all duration-300 hover:border-[#0A66C2]/40 hover:bg-[#0A66C2]/10 hover:scale-110"
                >
                ...
                {/* GitHub */}
                <a
                  href="https://github.com/syentropy"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="GitHub"
                  className="w-10 h-10 rounded-xl bg-surface-container-high/50 border border-outline-variant/20 flex items-center justify-center text-on-surface-variant/60 social-github transition-all duration-300 hover:border-on-surface/40 hover:bg-on-surface/10 hover:scale-110"
                >
