...
export default function Layout() {
  ...
  return (
    <div className="bg-background text-on-surface font-sans min-h-screen relative antialiased selection:bg-surface-tint selection:text-background overflow-x-hidden flex flex-col">
      ...
      <footer className="relative z-10 py-16 px-6 md:px-12 bg-surface-container-lowest border-t border-outline-variant select-none mt-auto">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-surface-container-high/50 border border-outline-variant flex items-center justify-center text-on-surface-variant/60 social-instagram transition-all duration-300 hover:border-[#E4405F]/40 hover:bg-[#E4405F]/10 hover:scale-110"
                >
                ...
                <a
                  ...
                  rel="noreferrer"
                  aria-label="WhatsApp"
                  className="w-10 h-10 rounded-xl bg-surface-container-high/50 border border-outline-variant flex items-center justify-center text-on-surface-variant/60 social-whatsapp transition-all duration-300 hover:border-[#25D366]/40 hover:bg-[#25D366]/10 hover:scale-110"
                >
