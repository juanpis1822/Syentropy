        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full glass-panel border border-outline-variant/20 text-on-surface-variant hover:text-[#0A66C2] hover:border-[#0A66C2]/40 hover:bg-[#0A66C2]/5 transition-all duration-300 text-sm font-medium group"
            >
