    ...
    <>
      ...
      <section className="relative py-14 sm:py-20 md:py-28 px-4 sm:px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel mb-6 border-surface-tint/20 bg-surface-container-low/40">
          ...
          >
            {[
              ...
              >
                <div className={`w-11 h-11 shrink-0 rounded-xl bg-surface-container-high border border-outline-variant flex items-center justify-center ${item.color} group-hover:scale-110 transition-transform`}>
                  {item.icon}
                </div>
                <div>
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full glass-panel border border-outline-variant text-on-surface-variant hover:text-[#25D366] hover:border-[#25D366]/40 hover:bg-[#25D366]/5 transition-all duration-300 text-sm font-medium group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full glass-panel border border-outline-variant text-on-surface-variant hover:text-[#E4405F] hover:border-[#E4405F]/40 hover:bg-[#E4405F]/5 transition-all duration-300 text-sm font-medium group"
            >
